...
//query to retrieve data from Products table to find how much total UnitsInStock you have from each Supplier.Group the SupplierID and calculate the sum of corresponding UnitsInStock for each supplier.Further filter the data to display records where SupplierID range between 10 to 30.
